...
_w['_sydConvTranslation'] = {
  ...
  notiUpdateBrowser: '很抱歉，不支持此版本的浏览器。请将浏览器更新到最新版本以继续。',
  ...
  newUserGreet: '欢迎！我是必应，我可以使用 AI 完成更多工作，例如帮助你找到完美的礼物、了解海洋或发现新音乐。告诉我你想要了解的内容！',
  newUserSugg1: '给我说个笑话',
  newUserSugg2: '玩小游戏',
  newUserSugg3: '给我讲一个谜语',
  repeatUserGreet: '很高兴你回来了！无论你想说什幺，我都持开放态度。我能为你做什么？',
  repeatUserSugg1: '有什么最新资讯',
  repeatUserSugg2: '向我展示一首诗',
  repeatUserSugg3: '给我说个笑话',
  creativeGreet: '让我们发挥创意吧！你是否在考虑某个主题，还是即兴发挥？',
  balancedGreet: '听起来不错，我们可以在趣事和事实中寻找平衡。如何提供帮助？',
  preciseGreet: '感谢聊天。今天我能帮你吗？',
  creativeSugg1: '告诉我一个奇怪的事实',
  creativeSugg2: '告诉我的星座',
  creativeSugg3: '给我一个你想问的问题',
  balancedSugg1: '写一首关于爆米花的诗',
  balancedSugg2: '蜜蜂如何酿蜜？',
  balancedSugg3: '我需要帮助制定计划',
  preciseSugg1: '谁发明语言？',
  ...
  scrollLeft: '向左滚动',
  scrollRight: '向右滚动',
  personalizationConsentTitleText: '✨ 对了，你想要个性化的答案吗?✨',
  personalizationConsentContentText1: '共享聊天历史记录时，必应会根据你和你的兴趣定制回复。',
  personalizationConsentContentText2: '。',
  personalizationConsentLearnMoreText: '了解有关个性化答案的详细信息',
  personalizationConsentEnableText: '是的，我想要!',
  personalizationConsentAskAgainLaterText: '以后再说',
