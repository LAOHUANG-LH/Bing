...
(function() {
    var n, t;
    typeof PerformanceObserver != "undefined" && typeof PerformanceObserver == "function" && (n = PerformanceObserver.supportedEntryTypes || [],
    n.indexOf("element") >= 0 && (t = new PerformanceObserver(function(n) {
        n.getEntries().forEach(function(n) {
            var i, t;
            typeof frpPreviousEntry == "undefined" && (window.frpPreviousEntry = n);
            typeof n.identifier != "undefined" && n.identifier && n.identifier.length > 0 && (i = n.identifier,
            i.startsWith("frp") && (t = Math.round(Math.min(window.frpPreviousEntry.renderTime, n.renderTime)),
            window.frp = t,
            _G.frp = t))
        })
    }
...
)(FRPMetricModule || (FRPMetricModule = {}));
...
(function(n) {
    function i(n) {
        return t in n ? n.textContent : n.innerText
    }
    function r(n, i) {
        t in n ? n.textContent = i : n.innerText = i
    }
    var t = "textContent";
    n.getText = i;
    n.setText = r
